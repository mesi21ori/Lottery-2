        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              ...
              />
              <h1 className="text-xl font-bold">Three Circle 7 - Admin Panel</h1>
            </div>
          ...
          <div className="flex-1 min-w-0">
            <div className="h-full">
                          ...
                          {results.map((result) => (
                            <div key={result.id} className="border rounded-lg p-4">
                              <div className="flex justify-between items-start mb-2">
                                <div>
                                  <h4 className="font-medium">{result.lottery}</h4>
              ...
              {activeTab === "lotteries" && (
                <div className="space-y-6">
                  <div className="flex justify-between items-center">
                    <h2 className="text-2xl font-bold text-gray-900">Lottery Management</h2>
                    <Button>
                      <Plus className="h-4 w-4 mr-2" />
                      Add New Lottery
                    </Button>
                          ...
                          <TableBody>
                            {lotteries.map((lottery) => (
                              <TableRow key={lottery.id}>
                                ...
                                <TableCell>{lottery.nextDraw}</TableCell>
                                <TableCell>
              ...
              {activeTab === "news" && (
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <Card>
                      <CardHeader>
                        <CardTitle>Add News & Announcements</CardTitle>
                        ...
                        <div className="space-y-4 max-h-96 overflow-y-auto">
                          {news.map((article) => (
                            <div key={article.id} className="border rounded-lg p-4">
                              ...
                              <p className="text-sm mb-3">{article.content}</p>
                              <div className="flex space-x-2">
                                <Button size="sm" variant="outline">
                                  <Edit className="h-4 w-4" />
                                </Button>
