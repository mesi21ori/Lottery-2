      ...
      {["Single", "Rajshree", "Choice"].map((item) => (
        <DropdownMenu key={item}>
          ...
          <DropdownMenuContent align="start" className="bg-red-800 text-white border-none">
            <DropdownMenuItem className="hover:bg-red-700 cursor-pointer">Add {item}</DropdownMenuItem>
            <DropdownMenuItem className="hover:bg-red-700 cursor-pointer">{item} List</DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      ))}
      <DropdownMenu>
        ...
        <DropdownMenuContent align="start" className="bg-red-800 text-white border-none">
          <DropdownMenuItem className="hover:bg-red-700 cursor-pointer">Dear Single Result</DropdownMenuItem>
          <DropdownMenuItem className="hover:bg-red-700 cursor-pointer">Rajshree Punjab Result</DropdownMenuItem>
        </DropdownMenuContent>
      </DropdownMenu>
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
        ...
        <DropdownMenuContent align="start" className="bg-red-800 text-white border-none">
          <DropdownMenuItem className="hover:bg-red-700 cursor-pointer">Dear Single Winning Report</DropdownMenuItem>
          <DropdownMenuItem className="hover:bg-red-700 cursor-pointer">
            Rajshree Punjab Winning Report
          </DropdownMenuItem>
          <DropdownMenuItem className="hover:bg-red-700 cursor-pointer">Choice Winning Report</DropdownMenuItem>
          <DropdownMenuItem className="hover:bg-red-700 cursor-pointer">Choice Customer Report</DropdownMenuItem>
        </DropdownMenuContent>
      </DropdownMenu>
      <Button
        variant="ghost"
