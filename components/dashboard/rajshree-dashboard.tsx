...
interface RajshreedashboardProps {
  username: string
  userRole: "user" | "admin"
}

export function Rajshreedashboard({ username, userRole }: RajshreedashboardProps) {
  const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false)
  const [selectedGame, setSelectedGame] = useState("Dear Rajshree")
