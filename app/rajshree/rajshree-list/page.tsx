...
export default function RajshreeListPage() {
  ...
  const [selectedGame, setSelectedGame] = useState("Rajshree Punjab") // Default game for GameInfoSection
